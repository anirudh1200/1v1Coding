...
let data = [
    ...
    {
        day: 3,
        question: "<p class=\" mathjax-support\">A tourist is visiting Byteland. The tourist knows English very well. The language of Byteland is rather different from English. To be exact it differs in following points:<\/p>\n<ul class=\" mathjax-support\">\n<li class=\" mathjax-support\">Bytelandian alphabet has the same letters as English one, but possibly different in meaning. Like \'A\' in Bytelandian may be \'M\' in English. However this does&nbsp;<strong class=\" mathjax-support\">not<\/strong>&nbsp;mean that \'M\' in Bytelandian must be \'A\' in English. More formally, Bytelindian alphabet is a permutation of English alphabet. It will be given to you and could be any possible permutation. Don\'t assume any other condition.<\/li>\n<li class=\" mathjax-support\">People of Byteland don\'t like to use invisible character for separating words. Hence instead of space (\' \') they use underscore (\'_\'). Other punctuation symbols, like \'?\', \'!\' remain the same as in English.<\/li>\n<\/ul>\n<p class=\" mathjax-support\">&nbsp;<\/p>\n<p class=\" mathjax-support\">The tourist is carrying \"The dummies guide to Bytelandian\", for translation. The book is serving his purpose nicely. But he is addicted to sharing on BaceFook, and shares his numerous conversations in Byteland on it. The conversations are rather long, and it is quite tedious to translate for his English friends, so he asks you to help him by writing a program to do the same.<\/p>\n<h3 class=\" mathjax-support\">Input<\/h3>\n<p class=\" mathjax-support\">The first line of the input contains an integer&nbsp;<strong class=\" mathjax-support\">T<\/strong>, denoting the length of the conversation, and the string&nbsp;<strong class=\" mathjax-support\">M<\/strong>, denoting the English translation of Bytelandian string&nbsp;<strong class=\" mathjax-support\">\"abcdefghijklmnopqrstuvwxyz\"<\/strong>.&nbsp;<strong class=\" mathjax-support\">T<\/strong>&nbsp;and&nbsp;<strong class=\" mathjax-support\">M<\/strong>&nbsp;are separated by exactly one space. Then&nbsp;<strong class=\" mathjax-support\">T<\/strong>&nbsp;lines follow, each containing a Bytelandian sentence&nbsp;<strong class=\" mathjax-support\">S<\/strong>&nbsp;which you should translate into English. See constraints for details.<\/p>\n<h3 class=\" mathjax-support\">Output<\/h3>\n<p class=\" mathjax-support\">For each of the sentence in the input, output its English translation on a separate line. Replace each underscores (\'_\') with a space (\' \') in the output. Each punctuation symbol (see below) should remain the same. Note that the uppercase letters in Bytelandian remain uppercase in English, and lowercase letters remain lowercase. See the example and its explanation for clarity.<\/p>\n<h3 class=\" mathjax-support\">Constraints<\/h3>\n<p class=\" mathjax-support\">&nbsp;<\/p>\n<ul class=\" mathjax-support\">\n<li class=\" mathjax-support\"><strong class=\" mathjax-support\">1<\/strong>&nbsp;&le;&nbsp;<strong class=\" mathjax-support\">T<\/strong>&nbsp;&le;&nbsp;<strong class=\" mathjax-support\">100<\/strong><\/li>\n<li class=\" mathjax-support\"><strong class=\" mathjax-support\">M<\/strong>&nbsp;is a permutation of&nbsp;<strong class=\" mathjax-support\">\"abcdefghijklmnopqrstuvwxyz\"<\/strong><\/li>\n<li class=\" mathjax-support\">Each sentence is non-empty and contains at most&nbsp;<strong class=\" mathjax-support\">100<\/strong>&nbsp;characters<\/li>\n<li class=\" mathjax-support\">Each sentence may contain only lowercase letters (\'a\'-\'z\'), uppercase letters (\'A\'-\'Z\'), underscores (\'_\') and punctuation symbols: dot (\'.\'), comma (\',\'), exclamation (\'!\'), question-mark(\'?\')<\/li>\n<\/ul>\n<p class=\" mathjax-support\">&nbsp;<\/p>\n<h3 class=\" mathjax-support\">Example<\/h3>\n<pre class=\" mathjax-support\"><strong class=\" mathjax-support\">Input:<\/strong>\n5 qwertyuiopasdfghjklzxcvbnm\nPh\nPcssi\nBpke_kdc_epclc_jcijsc_mihyo?\nEpcf_kdc_liswhyo_EIED_hy_Vimcvpcn_Zkdvp_siyo_viyecle.\nIpp!\n\n<strong class=\" mathjax-support\">Output:<\/strong>\nHi\nHello\nWhat are these people doing?\nThey are solving TOTR in Codechef March long contest.\nOhh!\n<\/pre>\n<h3 class=\" mathjax-support\">Explanation<\/h3>\n<p class=\" mathjax-support\">The string \"qwertyuiopasdfghjklzxcvbnm\" means that \'a\' in Bytelandian is \'q\' in English, \'b\' in Bytelandian is \'w\' in English, \'c\' in Bytelandian is \'e\' in English and so on.<br class=\" mathjax-support\" \/>Thus to translate \"Ph\" (first sentence in example) to English:<br class=\" mathjax-support\" \/>1) We find that \'p\' in Bytelandian means \'h\' in English. So we replace \'P\' with \'H\'.<br class=\" mathjax-support\" \/>2) Then we see that \'h\' in Bytelandian means \'i\' in English. So we replace \'h\' with \'i\'.<br class=\" mathjax-support\" \/>3) Therefore, the translation is \"Hi\".<\/p>",
        title: "Language",
        noOfTestCases: 5,
        testCases: ["5 qwertyuiopasdfghjklzxcvbnm\nPh\nPcssi\nBpke_kdc_epclc_jcijsc_mihyo?\nEpcf_kdc_liswhyo_EIED_hy_Vimcvpcn_Zkdvp_siyo_viyecle.\nIpp!"],
        testCasesAnswer: ["Hi","Hello","What are these people doing?","They are solving TOTR in Codechef March long contest.","Ohh!"],
        noOfPrivateCases: 7,
        privateCases: ["7 higjacebkomprntqzywsvuxdfl\nMy_name_is_sectret\ndo_You_doubt_me?\nin_this_sentence_i_am_TryIng_to_use_all_zxy_alphaggg\nwhy_are_there_seven_of_them!!\nthis_si_Tough_Question\nRANDOKM...adoshfudhb\ntestTestLLOO"],
        privateCasesAnswer: ["Rf nhra kw wagsyas",
"jt Ftv jtvis ra?","kn sbkw wansanga k hr SyfKne st vwa hpp ldf hpqbheee","xbf hya sbaya wauan tc sbar!!","sbkw wk Stveb Zvawsktn","YHNJTMR...hjtwbcvjbi","sawsSawsPPTT"]
},
{
       day: 3,
       question: "<section id=\"SECTION_1\">\n\t<div id=\"DIV_2\">\n\t\t<p id=\"P_3\">\n\t\t<\/p>\n\t\t<p id=\"P_4\">\n\t\t\tTrans bought a calculator at creatnx\'s store. Unfortunately, it is fake. It has many bugs. One of them is adding two numbers without carrying. Example expression: 12 + 9 will have result 11 in his calculator. Given an expression in the form <b id=\"B_5\">a + b<\/b>, please output result from that calculator.\n\t\t<\/p>\n\t\t<p id=\"P_6\">\n\t\t<\/p>\n\t\t<h3 id=\"H3_7\">\n\t\t\tInput\n\t\t<\/h3>\n\t\t<p id=\"P_8\">\n\t\t\tThe first line contains an integer <b id=\"B_9\">T<\/b> denote the number of test cases. Each test case contains two integers <b id=\"B_10\">a, b<\/b> in a single line.\n\t\t<\/p>\n\t\t<p id=\"P_11\">\n\t\t<\/p>\n\t\t<h3 id=\"H3_12\">\n\t\t\tOutput\n\t\t<\/h3>\n\t\t<p id=\"P_13\">\n\t\t\tEach test case, print answer in a single line.\n\t\t<\/p>\n\t\t<p id=\"P_14\">\n\t\t<\/p>\n\t\t<h3 id=\"H3_15\">\n\t\t\tConstraints\n\t\t<\/h3>\n\t\t<ul id=\"UL_16\">\n\t\t\t<li id=\"LI_17\">\n\t\t\t\t<b id=\"B_18\">1 ≤ T ≤ 100<\/b>\n\t\t\t<\/li>\n\t\t\t<li id=\"LI_19\">\n\t\t\t\t<b id=\"B_20\">1 ≤ a, b ≤ 10<sup id=\"SUP_21\">9<\/sup><\/b>\n\t\t\t<\/li>\n\t\t<\/ul>\n\t\t<p id=\"P_22\">\n\t\t<\/p>\n\t\t<ul id=\"UL_23\">\n\t\t<\/ul>\n\t\t<p id=\"P_24\">\n\t\t<\/p>\n\t\t<h3 id=\"H3_25\">\n\t\t\tExample\n\t\t<\/h3>\n\t\t<pre id=\"PRE_26\"><b class=\" mathjax-support\" id=\"B_27\">Input:<\/b>\n2\n12 9\n25 25\n\n<b class=\" mathjax-support\" id=\"B_28\">Output:<\/b>\n11\n40\n\t\t<\/pre>\n\t\t<p id=\"P_29\">\n\t\t\t<\/p>\n\t\t<!'+'--.problem-statement--'+'>\n\n\t\t<!'+'--.problem-info--'+'>\n\n\t\t<div id=\"DIV_30\">\n\t\t\t\t<input type=\"hidden\" value=\"value\" id=\"INPUT_31\" \/>\n\t\t\t<\/div>\n\t<\/div>\n<\/section>",
       title: 'Buggy Calc',
       noOfTestCases: 2,
       testCases: ["2\n12 9\n25 25"],
       ...
       noOfPrivateCases: 7,
       privateCases: ["15\n59278 900332\n955472 331407\n153332 463538\n793768 638463\n372411 601809\n835927 654202\n121577 621279\n38675 41982\n828340 540916\n875914 473053\n240975 946259\n669292 165554\n918537 982761\n678119 919906\n663744 129388"],
       privateCasesAnswer: ["959500", "286879", "516860", "321121", "973210", "489129", "742746", "79557", "368256", "248967", "186124", "724746", "890298", "587015", "782022"]
}];
